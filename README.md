...
| <a name="module_private_endpoint"></a> [private\_endpoint](#module\_private\_endpoint) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-private_endpoint.git | n/a |
...
| <a name="input_sku"></a> [sku](#input\_sku) | The SKU name of the container registry. Only Premium is supported for Private Link. | `string` | `"Premium"` | no |
